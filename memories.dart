...
////
  void loadItems() async {
    ...
    final jsonData = prefs.getString('items2');
    if (jsonData != null) {
...
////
  void saveItems() async {
    ...
    final itemsData = items
        ...
        .toList();
    prefs.setString('items2', json.encode(itemsData));
  }
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                showSnackBar(context, "okay canceled ",
                    Color.fromARGB(255, 241, 237, 5));
              },
            ),
            TextButton(
              child: Text('Save',
      ...
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Image.asset(
                  "assests/gif/4.gif", //screen wallpaper
                  fit: BoxFit.cover,
                ),
              ),
            ],
        ...
        SizedBox(
          ...
          child: Opacity(
            opacity: 0.6,
            child: Image.asset(
              "assests/gif/10.gif", //screen wallpaper
              fit: BoxFit.cover,
            ),
          ),
        ),
