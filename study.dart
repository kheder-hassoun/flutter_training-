...
class _ToDoListState extends State<StudyList> {
...
////
  void loadItems() async {
    ...
    final jsonData = prefs.getString('items3');
    if (jsonData != null) {
...
////
  void saveItems() async {
    ...
    final itemsData = items
        ...
        .toList();
    prefs.setString('items3', json.encode(itemsData));
  }
                  ...
                  children: <Widget>[
                    TextField(
                      ...
                      decoration: InputDecoration(
                          hintText: 'write ur study_task here ',
                          hintStyle: TextStyle(
                              fontSize: 13,
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                showSnackBar(
                    context, "okay canceld ", Color.fromARGB(255, 230, 3, 14));
              },
            ),
            TextButton(
              child: Text('Save',
      ...
      builder: (BuildContext context) {
        return ClipRRect(
          ...
          child: AlertDialog(
            ...
            content: Text("Are you sure you want to delete this study_task ✔?",
      ...
      children: [
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Opacity(
                  opacity: 0.01,
                  child: Image.asset(
                    "assests/wallpapers/w2.jpg", //screen wallpaper
                    fit: BoxFit.cover,
                  ),
                ),
              ),
        ...
        SizedBox(
          ...
          child: Opacity(
            opacity: 0.6,
            child: Image.asset(
              "assests/gif/6.gif", //screen wallpaper
              fit: BoxFit.cover,
            ),
          ),
        ),
